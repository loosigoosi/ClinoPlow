...
public class WITActivity extends AppCompatActivity implements IBluetoothFoundObserver, IBwt901clRecordObserver {
     ...
     */
        ...
        builder.append(getString(com.wit.sdk.R.string.accY)).append(":").append(bwt901cl.getDeviceData(WitSensorKey.AccY)).append("g \t");
        builder.append(getString(com.wit.sdk.R.string.accZ)).append(":").append(bwt901cl.getDeviceData(WitSensorKey.AccZ)).append("g \n");
        builder.append(getString(com.wit.sdk.R.string.asX)).append(":").append(bwt901cl.getDeviceData(WitSensorKey.AsX)).append("°/s \t");
        builder.append(getString(com.wit.sdk.R.string.asY)).append(":").append(bwt901cl.getDeviceData(WitSensorKey.AsY)).append("°/s \t");
        builder.append(getString(com.wit.sdk.R.string.asZ)).append(":").append(bwt901cl.getDeviceData(WitSensorKey.AsZ)).append("°/s \n");
        builder.append(getString(com.wit.sdk.R.string.angleX)).append(":").append(bwt901cl.getDeviceData(WitSensorKey.AngleX)).append("° \t");
        builder.append(getString(com.wit.sdk.R.string.angleY)).append(":").append(bwt901cl.getDeviceData(WitSensorKey.AngleY)).append("° \t");
        builder.append(getString(com.wit.sdk.R.string.angleZ)).append(":").append(bwt901cl.getDeviceData(WitSensorKey.AngleZ)).append("° \n");
        builder.append(getString(com.wit.sdk.R.string.hX)).append(":").append(bwt901cl.getDeviceData(WitSensorKey.HX)).append("\t");
        builder.append(getString(com.wit.sdk.R.string.hY)).append(":").append(bwt901cl.getDeviceData(WitSensorKey.HY)).append("\t");
        builder.append(getString(com.wit.sdk.R.string.hZ)).append(":").append(bwt901cl.getDeviceData(WitSensorKey.HZ)).append("\n");
